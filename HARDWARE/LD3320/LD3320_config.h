...
#define CODE_KD	1	 //开灯
#define CODE_GD	  2	 //关灯
#define CODE_DLD	3 //低亮度
#define CODE_ZCLD	4	 //正常亮度
#define CODE_GLD	5  //高亮度
#define CODE_LSW	6  //冷色温
#define CODE_ZCSW	7  //正常色温
#define CODE_NSW	8  //暖色温
#define CODE_KQLY	9  //开启蓝牙
#define CODE_GBLY	10  //关闭蓝牙
